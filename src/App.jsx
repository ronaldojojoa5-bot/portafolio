    ...
    <section id="proyectos" className="sec sec-ink">
      <div className="wrap">
        ...
        <Reveal className="proj-note">
          <Star size={13} />
          <span className="mono">
            Las portadas son tipográficas mientras se cargan las piezas finales
          </span>
        </Reveal>
      </div>
    </section>
...
export default function App() {
  ...
  return (
    <>
      ...
      <main>
        <Hero />
        <Marquee items={PERFIL.estudio + ' ' + PERFIL.estudioSub + ' · ' + PERFIL.rol + ' '} />
        <Servicios />
        <Proyectos />
        <Marquee
          items="Branding · Ilustración · Diseño web · Diseño interactivo "
          reverse
          tone="ink"
        />
        <Estudio />
